    ...
    children: [
      {
        ...
        loader: landingLoader(queryClient), // return products (fatured products)
      },
      {
        path: "products",
        element: <Products />,
        errorElement: <ErrorElement />,
        loader: productsLoader(queryClient), // return products and meta
      },
      {
        path: "products/:id",
        element: <SingleProduct />,
        errorElement: <ErrorElement />,
        loader: singleProductLoader(queryClient), //return product
      },
      {
        path: "cart",
        element: <Cart />,
