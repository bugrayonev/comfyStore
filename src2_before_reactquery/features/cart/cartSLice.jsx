...
const cartSlice = createSlice({
  ...
  reducers: {
    ...
    clearCart: (state) => {
      ...
      return defaultState; // bunu yapmasak localstorage i değiştirsek bile sayfa refresh olmadan değişikliği göremeyiz
    },
    ...
    editItem: (state, action) => {
      ...
      item.amount = amount;
      cartSlice.caseReducers.calculateTotals(state);
      toast.success('Cart updated');  // bu kod üsteki iki kodun altında çalıştırılmalı
